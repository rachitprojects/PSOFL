...
with open("fedadaptunresdata.txt","r") as file1:
	strfile=file1.read()
	strlist=list()
...
#print("searching string is   ",srchstr)
		...
		train_ind_start = re.search("Total Round Execution time", temp_str).span()[1]
		train_ind_end = re.search("Initialisation Times are", temp_str).span()[0]
